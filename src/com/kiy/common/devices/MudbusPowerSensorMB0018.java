...
/**
 * Mudbus断电传感器(ZZ-IO204开关量集成)
 * 型号 MB_0018
 * @author HLX Tel:18996470535 
 * @date 2018年6月1日 
 * Copyright:Copyright(c) 2018
 */
public class MudbusPowerSensorMB0018 extends Device{
	
	private static final long serialVersionUID = 1L;
	
	private boolean feed;// 报警状态

	public MudbusPowerSensorMB0018( ) {
		super(Vendor.MUDBUS, Kind.SENSOR_POWER, Model.MB_0018);
	}
