...
/**
 * 四路开关执行器开关2(东软载波带电流检测)
 */
public class ESSwitchFourES0020_02 extends Device{
...
private static final long serialVersionUID = 1L;
	...
	public ESSwitchFourES0020_02() {
		super(Vendor.EASTSOFT, Kind.SWITCH_FOUR, Model.ES_0020_02);
	}
