...
/**
 * MUDBUS-妙昕 温湿度传感器 TH10S-B
 * 型号 ES_0007
 * @author HLX Tel:18996470535 
 * @date 2018年4月26日 
 * Copyright:Copyright(c) 2018
 */
public class ESPLC2RS485HumitureSensorES0007 extends Device{
	...
	public ESPLC2RS485HumitureSensorES0007() {
		super(Vendor.EASTSOFT, Kind.SENSOR_MOISTURE_TEMPERATURE,Model.ES_0007);
	}
