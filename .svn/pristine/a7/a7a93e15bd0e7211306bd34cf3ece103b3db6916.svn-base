 ...
 *
 */
public final class KSTemperatureMoistureSensor extends Device {
	...
	public KSTemperatureMoistureSensor() {
		super(Vendor.KAISTAR, Kind.SENSOR_MOISTURE_TEMPERATURE,Model.KS_0010);
	}
