...
/**
 * 四路开关执行器开关3(东软载波带电流检测)
 */
public class ESSwitchFourES0020_03 extends Device{
	...
	public ESSwitchFourES0020_03() {
		super(Vendor.EASTSOFT, Kind.SWITCH_FOUR, Model.ES_0020_03);
	}
