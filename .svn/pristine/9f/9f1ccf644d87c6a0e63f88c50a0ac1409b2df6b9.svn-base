 ...
 */
public class MudbusHumitureSensorMB0003 extends Device{
	...
	public MudbusHumitureSensorMB0003() {
		super(Vendor.MUDBUS, Kind.SENSOR_MOISTURE_TEMPERATURE,Model.MB_0003);
	}
