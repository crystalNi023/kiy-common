...
/**
 * Mudbus烟雾传感器(ZZ-IO204开关量集成)
 * 型号 MB_0011
 * @author HLX Tel:18996470535 
 * @date 2018年6月1日 
 * Copyright:Copyright(c) 2018
 */
public class MudbusSmokeSensorMB0011 extends Device{
	
	private static final long serialVersionUID = 1L;
	
	private boolean feed;// 报警状态

	public MudbusSmokeSensorMB0011( ) {
		super(Vendor.MUDBUS, Kind.SENSOR_SMOKE, Model.MB_0011);
	}
