...
/**
 * mudbus对接射频编解码模块(飞音云电子433,315无线接收)
 * 型号  MB_0021
 */
public class ModbusSerialRadioFrequencyMB0021 extends Device {
	...
	public ModbusSerialRadioFrequencyMB0021() {
		super(Vendor.MUDBUS, Kind.SERIAL_RADIO_FREQUENCY,Model.MB_0021);
	}
